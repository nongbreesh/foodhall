    ...
    if(rowData != null){
      ...
      render() {
        ...
        return (
          ...
          animationType={"slide"}
          transparent={true}
          visible={this.state.modalRangeVisible}
          onRequestClose={() => {alert("Modal has been closed.")}}
          >
          <View style={{marginTop: 22,flex:1,backgroundColor:'rgba(0,0,0,.3)'}}>
          <View style={{backgroundColor:'#FFFFFF',flex:1,}}>
          <Grid style={{position:'absolute',left:10,top:10}}>
          <Row>
          <Image
          ...
          <TouchableOpacity onPress={() => {
            this.setModalRangeVisible(!this.state.modalRangeVisible)
          }}>
          <Icon style={{color:'#000000',position:'absolute',right:10,top:0,fontSize:42,}} name='ios-close-outline' />
          </TouchableOpacity>
          ...
          <Picker
          selectedValue={this.state.orderrange}
          onValueChange={(range) => this.setState({orderrange: range})}>
          <Picker.Item label="08:00น. - 11:00น." value="08:00น. - 11:00น." />
          <Picker.Item label="13:00น. - 17:00น." value="13:00น. - 17:00น." />
          </Picker>
          ...
          <TouchableOpacity onPress={() => {
            this.confirmorder(!this.state.modalRangeVisible)
          }}>
          <View  style={{backgroundColor:'#F3C42C',position:'absolute',left:0,right:0,bottom:0, flexDirection: 'row',  alignItems: 'center', justifyContent: 'center',  marginTop:24,padding:16  }}>
          <Text
          style={{
